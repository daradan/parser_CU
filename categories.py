### If you want scrape all categories, you need uncomment lines from 2 to 32 and comment lines from 33 to 55
# import requests
# import config
#
#
...
def get_categories() -> list:
    categories = [
        {'id': 38, 'id_parent': 1745, 'name': 'Laptops / Notebooks', 'url': 'c/laptops-tablet-pcs-pcs/laptops-notebooks'},
        ...
        {'id': 1008, 'id_parent': 1715, 'name': 'PCI Express Graphics Cards', 'url': 'c/hardware-components/pci-express-graphics-cards'},
        ...
        {'id': 535, 'id_parent': 998, 'name': 'CPU Cooler & CPU Fans', 'url': 'c/hardware-components/prozessor-coolers-cpu-coolers'},
        {'id': 766, 'id_parent': 1727, 'name': 'Smartphones & Cell Phones', 'url': 'c/smartphones-radio-gps/smartphones-cell-phones'},
        ...
        {'id': 1870, 'id_parent': 1869, 'name': 'Sony PlayStation 5 Consoles', 'url': 'c/games-entertainment/sony-playstation-5-consoles'},
        {'id': 1827, 'id_parent': 1826, 'name': 'Nintendo Switch Consoles', 'url': 'c/games-entertainment/nintendo-switch-consoles'},
        {'id': 1866, 'id_parent': 1865, 'name': 'Xbox Series X Consoles', 'url': 'c/games-entertainment/xbox-series-x-consoles'},
        {'id': 1476, 'id_parent': 1473, 'name': 'Robotic Vacuum Cleaners', 'url': 'c/home-appliance/robotic-vacuum-cleaners'},
    ]
    return categories
